...
*(Add a screenshot of `reports/model_drift_report.html` here after opening
it in your browser, e.g. `![Drift Report](reports/screenshot.png)`)*
...
- Compare Logistic Regression vs. Random Forest under the same drift.
- Sweep the label-flip percentage (5%, 10%, 20%, 30%) and plot accuracy vs.
  drift severity.
- Convert this pipeline into a Jupyter Notebook for a step-by-step walkthrough.
